@log.trace("Started execution 'flint-snow:microsoft-cloud:customer:subscription:http_reqeust.rb' flintbit...") # execution Started
begin
...
@log.trace("Finished execution 'flint-snow:microsoft-cloud:customer:subscription:http_reqeust.rb' flintbit...") # Execution Finished
